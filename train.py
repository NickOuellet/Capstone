...
image_root = '/media/nick_ouellet/blurred_data/img/'
gt_root = '/media/nick_ouellet/blurred_data/gt/'
mask_root = '/media/nick_ouellet/blurred_data/mask/'
edge_root = '/media/nick_ouellet/blurred_data/edge/'
grayimg_root = '/media/nick_ouellet/blurred_data/gray/'
